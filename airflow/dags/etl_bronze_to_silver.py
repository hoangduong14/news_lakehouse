...
# with DAG(
#     dag_id="gcs_bronze_to_silver_docker",
#     default_args=default_args,
#     schedule_interval="@daily",   # chạy hàng ngày
#     start_date=datetime(2025, 1, 1),
#     catchup=False,
#     tags=["etl", "spark", "bronze_to_silver"],
# ) as dag:

#     run_spark_job = DockerOperator(
#         task_id="run_spark_gcs_bronze_to_silver",
#         image="etl-gateway:latest",
#         api_version="auto",
#         auto_remove=True,  # container xong thì xóa luôn
#         command="""
...
#           --driver-memory 4g \
#           --executor-memory 2g \
#           /opt/spark_jobs/gcs_bronze_to_silver.py
#         """,
...
def push_etl_metrics(ti, dag, **_):
    ...
    """
    monitored_task_id = "run_spark_gcs_bronze_to_silver"
    ...
    if not spark_ti or not spark_ti.start_date or not spark_ti.end_date:
        # Nếu vì lý do gì đó chưa có thời gian thì bỏ qua
        return
